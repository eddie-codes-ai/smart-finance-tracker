...
class _AddExpenseScreenState extends State<AddExpenseScreen> {
  ...
  static const List<String> _recurrenceOptions = ['daily', 'weekly', 'biweekly', 'monthly'];
    ...
    try {
      ...
      setState(() {
        _categories = AppConstants.expenseCategories
            .map((c) => UserCategoryModel.defaultCategory(c)).toList();
      });
    } finally {
    ...
    showDialog(context: context,
        builder: (ctx) => AlertDialog(
          ...
          actions: [
            ...
            TextButton(onPressed: () => _submitNewCategory(ctx, controller.text), child: const Text('Add')),
          ],
        ));
  }
  ...
  Future<void> _submitNewCategory(BuildContext ctx, String name) async {
    ...
    try {
      ...
      if (data['status'] == 'success') {
        ...
        setState(() { _categories.add(newCat); _selectedCategory = newCat.name; });
  ...
  Future<void> _deleteCustomCategory(UserCategoryModel cat) async {
    final confirm = await showDialog<bool>(context: context,
        builder: (ctx) => AlertDialog(
          ...
          content: Text('Delete "${cat.name}"? Existing expenses with this category will not be affected.'),
          actions: [
  ...
  Future<void> _submit() async {
    ...
    final recurrence = _selectedExpenseType == 'recurring' ? _selectedRecurrence : null;
    final double? budgetLimit = context.read<BudgetProvider>().limitFor(_selectedCategory);
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(hintText: '0.00',
                    prefixText: 'KES  ', prefixIcon: Icon(Icons.attach_money)),
                      ...
                      children: [
                        ..._categories.map((cat) {
                          ...
                          return GestureDetector(
                            ...
                            onLongPress: cat.isCustom ? () => _deleteCustomCategory(cat) : null,
                            child: Container(
                              ...
                              child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                Icon(_categoryIcons[cat.name] ?? Icons.label_outlined,
                                    size: 14,
                                    color: isSelected
                                        ? Colors.white
                ...
                children: AppConstants.expenseTypes.map((type) {
                  ...
                  return GestureDetector(
                    onTap: () => setState(() {
                      ...
                      if (type != 'recurring') _selectedRecurrence = null;
                    }),
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: isSelected ? AppTheme.primary : dividerColor),
                      ),
                      child: Text(_expenseTypeLabel(type), style: TextStyle(
              ...
              if (_selectedExpenseType == 'recurring') ...[
                ...
                DropdownButtonFormField<String>(
                  ...
                  validator: (value) {
                    if (_selectedExpenseType == 'recurring' && (value == null || value.isEmpty)) {
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(isLoading ? 'Saving...' : 'Save Expense Record'),
                ),
              ),
            ],
          ),
