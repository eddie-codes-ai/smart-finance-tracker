...
// Account settings screen — lets the user edit their username, email,
// and password. Accessible via the person icon in the main AppBar.
//
...
//
// On success each section shows a confirmation snackbar and collapses.
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget _buildEmailForm(String? currentEmail) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
        // Warning banner if no email set yet
