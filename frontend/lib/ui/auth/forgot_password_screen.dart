...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
      ...
      children: [
        ...
        TextField(
          ...
          decoration: const InputDecoration(
            labelText: 'Email Address', hintText: 'e.g. yourname@gmail.com',
  ...
  Widget _buildSuccess() {
    ...
    return Column(
      ...
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
        const Icon(Icons.mark_email_read, size: 88, color: Colors.green),
        const SizedBox(height: 24),
        ...
        ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(backgroundColor: AppTheme.primary,
              padding: const EdgeInsets.symmetric(vertical: 16)),
          child: const Text('Enter Reset Code', style: TextStyle(color: Colors.white, fontSize: 16)),
        ),
        const SizedBox(height: 12),
        TextButton(onPressed: () => setState(() => _submitted = false),
