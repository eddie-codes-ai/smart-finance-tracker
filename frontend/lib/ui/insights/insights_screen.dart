    ...
    return RefreshIndicator(
      ...
      child: analysis.isLoading
          ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Text('Running financial analysis...', style: TextStyle(color: cs.onSurface.withValues(alpha: 0.6))),
            ]))
          : !analysis.hasResult
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Generated by the rule engine based on your data.',
    ...
    return SingleChildScrollView(
      ...
      child: SizedBox(height: 400,
          child: Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            Icon(Icons.analytics_outlined, size: 52, color: cs.onSurface.withValues(alpha: 0.4)),
            const SizedBox(height: 12),
