        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              subtitle: Text('Log a new income record', style: TextStyle(color: cs.onSurface.withValues(alpha: 0.6))),
            ...
            ListTile(
              ...
              subtitle: Text('Log a new expense record', style: TextStyle(color: cs.onSurface.withValues(alpha: 0.6))),
            ...
            ListTile(
              ...
              subtitle: Text('Set a new savings target', style: TextStyle(color: cs.onSurface.withValues(alpha: 0.6))),
            ...
            ListTile(
              ...
              subtitle: Text('Paste or read SMS automatically', style: TextStyle(color: cs.onSurface.withValues(alpha: 0.6))),
