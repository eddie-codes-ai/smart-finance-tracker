...
class _DashboardScreenState extends State<DashboardScreen> {
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Text('/100',
                    style: TextStyle(color: Colors.white60, fontSize: 18, fontWeight: FontWeight.w500)),
              ),
            ],
          ),
          ...
          Row(
            children: [
              ...
              Text(_trendLabel(result.spendingTrend),
  ...
  Widget _buildScoreCardSkeleton() {
    return Container(
      margin: const EdgeInsets.symmetric(horizontal: 16),
      height: 190,
      decoration: BoxDecoration(color: AppTheme.divider, borderRadius: BorderRadius.circular(16)),
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    color: Colors.white.withOpacity(0.2), borderRadius: BorderRadius.circular(20)),
                child: const Text('Not Calculated',
          ...
          Row(
            ...
            children: [
              const Text('—',
                  style: TextStyle(color: Colors.white54, fontSize: 56, fontWeight: FontWeight.w800, height: 1)),
              const Padding(
                padding: EdgeInsets.only(bottom: 8, left: 4),
                child: Text('/100',
          ...
          const SizedBox(height: 6),
          const Text('Add income and expenses to get your score',
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 6),
              const Text('Your score updates when you log transactions',
              ...
              TextButton(
                ...
                style: TextButton.styleFrom(
                    foregroundColor: Colors.white, padding: EdgeInsets.zero,
                    minimumSize: Size.zero, tapTargetSize: MaterialTapTargetSize.shrinkWrap),
                child: const Text('Add Income →', style: TextStyle(fontSize: 12)),
              ),
            ],
          ),
        ],
            ...
            children: [
              ...
              const Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Get Started', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 15)),
  ...
  Widget _onboardingStep({
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isDone ? AppTheme.primary.withOpacity(0.05) : AppTheme.background,
          borderRadius: BorderRadius.circular(10),
          border: Border.all(color: isDone ? AppTheme.primary.withOpacity(0.2) : AppTheme.divider),
        ),
        child: Row(
          children: [
            ...
            Container(
              width: 28, height: 28,
              decoration: BoxDecoration(
                color: isDone ? AppTheme.primary : AppTheme.primary.withOpacity(0.12),
            ...
            Icon(isDone ? Icons.check_circle : Icons.chevron_right,
                size: 18, color: isDone ? AppTheme.primary : AppTheme.textSecondary),
          ],
        ),
      ),
    );
  ...
  Widget _summaryCard({
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Icon(icon, size: 18, color: isEmpty ? AppTheme.textSecondary.withOpacity(0.5) : color),
          const SizedBox(height: 8),
          Text(label, style: const TextStyle(fontSize: 11, color: AppTheme.textSecondary)),
          const SizedBox(height: 2),
          isEmpty
              ? Text('KES 0', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700,
